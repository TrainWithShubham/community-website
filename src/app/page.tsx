...
import { getLeaderboardData, getJobs, getCommunityStats, getCommunityQuestions } from '@/services/google-sheets';
import { SectionDivider } from '@/components/section-divider';


export default async function Home() {
  // Fix: Use Google Sheets data instead of static data for consistency
  const allCommunityQuestions = await getCommunityQuestions();
  ...
  return (
    <div className="container mx-auto px-4 py-8 md:py-12">
      ...
      <section className="text-center py-8 md:py-12" id="leaderboard">
        ...
        <Card className="max-w-full md:max-w-4xl mx-auto bg-card card-neo-border">
